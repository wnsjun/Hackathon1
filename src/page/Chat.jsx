...
export const ChatPage = () => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-white">
      ...
      {/* 채팅방 */}
      <section className="w-[761px] h-[774px] flex-1 flex-col m-12 p-8 bg-white border rounded" style={{ minHeight: "774px" }}>
        <div className="flex justify-between items-center mb-6">
          <span className="font-bold text-lg">닉네임</span>
          <button className="border px-4 py-2 rounded font-semibold cursor-pointer">결제하기</button>
        </div>
        {/* 채팅 메시지 예시 */}
        ...
        {/* 입력창 */}
        <div className="items-center border rounded px-4 py-2 w-full">
          <input
